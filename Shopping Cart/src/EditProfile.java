...
public class EditProfile extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditProfile frame = new EditProfile(new User());
	...
	public EditProfile(User user) {
		...
		retypePw.setText("Retype New Password");
		password.setForeground(Color.gray);
		retypePw.setColumns(10);
		retypePw.setBounds(160, 120, 190, 19);
		contentPane.add(retypePw);

		streetAddress = new JTextField(user.street);
		streetAddress.setForeground(Color.gray);
		...
		JLabel lblName = new JLabel(user.userName);
		lblName.setBounds(160, 22, 190, 15);
